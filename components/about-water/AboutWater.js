				...
				<div className='flex sd:flex-row xz:flex-col items-center justify-between mt-5'>
					...
					<div className='sd:w-2/3 xz:w-full'>
						...
						<div className='flex flex-col mt-5'>
							...
							<div className='mt-6'>
								<Image src='/svg/singer.svg' alt='Особенность воды' width={60} height={60} />
								<div className='mt-2'>
									<p className=''>
										Полина Гагарина Амбассадор воды “ТБАУ”. Полина в отличной физической форме благодаря здоровому образу жизни, обязательным условием которого является употребление достаточного количества качественной, чистой питьевой воды.
									</p>
								</div>
							</div>
						</div>
